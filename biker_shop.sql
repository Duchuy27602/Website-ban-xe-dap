...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 11, 2023 lúc 07:32 AM
...
(48, 48, 61, 16, 250, 1, 4, 5, 'Tốt', '2023-09-20 09:42:45'),
(49, 48, 54, 16, 100, 1, 4, 5, 'Đẹp', '2023-09-20 09:43:11'),
(50, 48, 47, 16, 3000, 1, 4, 5, 'chất lượng', '2023-09-20 09:43:20');
...
(47, 25, 'Xe đạp đua RIKULAU ILI ILI', 'xe-dap-dua-rikulau-ili-ili-30', 'Thương hiệu: Rikulau\r\nChất liệu khung: Thép không gỉ\r\nLoại phanh: Phanh đĩa cơ TEKTRO\r\nPhuộc giảm xóc: Sợi carbon\r\nLíp: SRAM PG 1130, 11-30T, 11S\r\nGiò đĩa: SRAM APEX 1,42T*170L\r\nTay đề: SRAM APEX 1, 1x11S\r\nĐề trước: Không\r\nĐề sau: SRAM APEX 1 11S\r\nTốc độ: 11\r\nVành xe: Hợp kim nhôm 2 lớp\r\nKích cỡ bánh xe: 700\r\nLốp xe: Schwalbe G-One 700x38C\r\nDây âm sườn: Có\r\nGấp gọn: Không', 'Xe đạp đua RIKULAU ILI ILI đến từ thị trường Đài Loan vô cùng khó tính sở hữu thiết kế vô cùng ấn tượng với kiểu dáng thể thao, khỏe khoắn thích hợp với người dùng có nhu cầu đi lại hằng ngày, đi phượt. Mẫu xe ra đời cùng với bộ khung thép, hệ thống truyền động 11 tốc độ.', 3043, 3000, '1683354823.webp', 9, 0, '2023-05-06 06:33:43'),
...
(48, 'USER', 'user@gmail.com', '0123456789', 'Hà Nội', '$2y$10$xdjSZRMIoP0YFO0YwU.iQ.skU42QD41hwyn6h4XXGlJB0rCmkgnvO', 0, '2023-05-05 13:02:43'),
(49, 'ADMIN', 'admin@gmail.com', '0123456789', NULL, '$2y$10$pOa6TRuABtdkJRk9HXcIzOvJNNu1UReWe1rIM/Yn27rOkX4RlqaLG', 1, '2023-05-05 13:33:13');
